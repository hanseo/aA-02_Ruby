...
=begin
p [1, 3, 5].bubble_sort! { |num1, num2| num1 <=> num2 } #=> [1, 3, 5]
p [1, 3, 5].bubble_sort! { |num1, num2| num2 <=> num1 } #=> [5, 3, 1]
p [1, 3, 2, 5, 4].bubble_sort! { |num1, num2| num2 ** 2 <=> num1 ** 2 } #=> [5, 4, 3, 2, 1]
p [1, 3, 2, 5, 4].bubble_sort! #=> [1, 2, 3, 4, 5]

p [1, 3, 5].bubble_sort
p [1, 3, 2, 5, 4].bubble_sort { |num1, num2| num2 ** 2 <=> num1 ** 2 }
=end
...
def substrings(string)
  ...
  (0...string.length).each do |i_1|
    (i_1...string.length).each do |i_2|
      subs << string[i_1..i_2]
    end
  end
...
=begin
p [1, 2, 3].my_map { |el| el * el } #to eq([1, 4, 9])
p [-1, 0, 1].my_map { |el| el.odd? } #to eq([true, false, true]

p [1, 2, 3, 4, 5].my_select(&:odd?) #to eq([1, 3, 5])
p [1, 2, 3, 4, 5].my_select { |el| el < 3 } #to eq([1, 2])
=end
